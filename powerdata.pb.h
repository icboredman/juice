...
// string appversion = 4;
inline void Gauge::clear_appversion() {
  _impl_.appversion_.ClearToEmpty();
}
inline const std::string& Gauge::appversion() const {
  // @@protoc_insertion_point(field_get:protopower.Gauge.appversion)
  return _internal_appversion();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Gauge::set_appversion(ArgT0&& arg0, ArgT... args) {
 
 _impl_.appversion_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:protopower.Gauge.appversion)
}
inline std::string* Gauge::mutable_appversion() {
  std::string* _s = _internal_mutable_appversion();
  // @@protoc_insertion_point(field_mutable:protopower.Gauge.appversion)
  return _s;
}
inline const std::string& Gauge::_internal_appversion() const {
  return _impl_.appversion_.Get();
}
inline void Gauge::_internal_set_appversion(const std::string& value) {
  
  _impl_.appversion_.Set(value, GetArenaForAllocation());
}
inline std::string* Gauge::_internal_mutable_appversion() {
  
  return _impl_.appversion_.Mutable(GetArenaForAllocation());
}
inline std::string* Gauge::release_appversion() {
  // @@protoc_insertion_point(field_release:protopower.Gauge.appversion)
  return _impl_.appversion_.Release();
}
inline void Gauge::set_allocated_appversion(std::string* appversion) {
